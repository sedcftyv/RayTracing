...
public:
	...
	virtual double pdf_value(const Vector3f& origin, const Vector3f& v) const override {
		hit_record rec;
	...
	virtual Vector3f random(const Vector3f& origin) const override {
		auto random_point = Vector3f(random_double(x0, x1), k, random_double(z0, z1));
